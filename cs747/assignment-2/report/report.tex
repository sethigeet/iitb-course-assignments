...
\begin{itemize}[left=1.25em]
  \item \textbf{Always Add when Safe}: The optimal policy seems to add while there is zero bust probability. This shortens effective horizons and helps reach the threshold quicker.
